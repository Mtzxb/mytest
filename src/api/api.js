...
let base = 'http://192.168.0.158:8122'
...
export const requestLogin = params => {
    return axios.get(`${base}/api/Manager/Login`, { params: params }).then(res => res.data)
}

//获取产品分类
export const getCategory = params => {
    return axios.get(`${base}/api/Category`, { params: params }).then(res => res.data)
}
//获取产品列表
export const getProduct = params => {
    return axios.get(`${base}/api/Product`, { params: params }).then(res => res.data)
}

//上传产品
export const updataProduct = params => {
    return axios.post(`${base}/api/Product`, params ).then(res => res.data)
}

//企业管理

export const CreateCompany = params => {
    return axios.post(`${base}/api/Business`, params ).then(res => res.data)
}
/*
	订单相关接口封装
*/
...
export const getOrder = params => {
    return axios.get(`${base}/api/Order`, { params: params }).then(res => res.data)
}
...
export const getBusinessList = params => {
    return axios.get(`${base}/api/Business`, { params: params }).then(res => res.data)
}
