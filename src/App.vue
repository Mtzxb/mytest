             ...
             <el-col>
                   <el-menu
                    ...
                    <el-submenu index="3">
                        ...
                        <el-menu-item index="/Manger/Company">企业列表</el-menu-item>
                        <el-menu-item index="/Manger/Create">创建企业</el-menu-item>
                    </el-submenu>                   
                    <el-submenu index="5">
                        <template slot="title">系统管理</template>
                        <el-menu-item index="5-1">管理员列表</el-menu-item>
                        <el-menu-item index="5-2">管理员权限</el-menu-item>
                        <el-menu-item index="5-3">价格配置</el-menu-item>
                        <el-menu-item index="5-4">通知设置</el-menu-item>
                    </el-submenu>
                  </el-menu>
             </el-col>
...
export default {
  ...
  created(){
  	var TokenExpireTime = new Date(localStorage.TokenExpire).getTime();
  	var nowTime = new Date().getTime();
  	if(nowTime < TokenExpireTime){
  		this.$store.commit('saveToken', localStorage.Token);
  		this.$store.commit('saveTokenExpire', localStorage.TokenExpire)
  	}
  },
  methods: {
